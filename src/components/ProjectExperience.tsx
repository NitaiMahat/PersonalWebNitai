...
export default function ProjectExperience() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f3efe6] px-4 py-20 text-[#1f2937] md:px-6 md:py-24">
      ...
      <div className="relative mx-auto max-w-7xl">
        <motion.div
          ...
          className="grid gap-8 xl:grid-cols-[320px_minmax(0,1fr)]"
        >
          <aside className="xl:sticky xl:top-8 xl:self-start">
            ...
            <p className="mt-8 text-xs font-semibold uppercase tracking-[0.32em] text-[#0f766e]">
              Full project atlas
            </p>
            <h1 className="mt-3 font-display text-4xl font-bold text-[#102a43] md:text-5xl">
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 text-center">
              <div className="rounded-2xl border border-[#0f3d4c]/10 bg-white/70 p-4">
                <p className="text-[0.7rem] uppercase tracking-[0.18em] text-[#486581]">
                  Projects
                </p>
              ...
              <div className="rounded-2xl border border-[#0f3d4c]/10 bg-white/70 p-4">
                ...
                <p className="mt-2 text-2xl font-semibold text-[#102a43]">8</p>
              </div>
              <div className="rounded-2xl border border-[#0f3d4c]/10 bg-white/70 p-4">
                <p className="text-[0.7rem] uppercase tracking-[0.18em] text-[#486581]">
                  Live
            ...
            <div className="mt-8 flex flex-wrap gap-2 xl:max-w-[18rem]">
          ...
          <section className="grid grid-cols-1 gap-5 lg:grid-cols-2">
            {visibleProjects.map((project, index) => (
              <motion.article
                ...
                className="relative overflow-hidden rounded-[30px] border border-[#0f3d4c]/10 bg-white/78 p-6 shadow-[0_22px_60px_rgba(15,61,76,0.08)] backdrop-blur-sm"
              >
                <div
                ...
                <div className="relative">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h2 className="mt-2 font-display text-2xl font-bold text-[#102a43]">
                        {project.name}
                      </h2>
                      <p className="mt-2 text-sm text-[#486581]">{project.tagline}</p>
                    </div>
                    <span
                  ...
                  <p className="mt-5 text-sm leading-7 text-[#334e68]">
                    {project.summary}
                  </p>

                  <ul className="mt-5 space-y-3 text-sm leading-6 text-[#243b53]">
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    {project.tech.map((item) => (
                      <span
                        key={item}
                        className="rounded-full border border-[#0f3d4c]/10 bg-[#f8fbfc] px-3 py-1 text-[0.7rem] font-medium uppercase tracking-[0.14em] text-[#486581]"
                      >
                        {item}
                      </span>
                    ))}
                  ...
                  <div className="mt-6 border-t border-[#0f3d4c]/10 pt-4 text-xs uppercase tracking-[0.18em] text-[#486581]">
                    {project.tags.join(" / ")}
                  </div>
                </div>
              </motion.article>
